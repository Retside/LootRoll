...
public class LootManager {
    ...
    private Map<String, MobLootConfig> mobLootMap;
    ...
    public void loadLootConfiguration() {
        ...
        plugin.getLogger().info("Loaded loot configuration for " + totalMobs + " mobs from " + dropConfigs.size() + " drop files");
    }
    ...
    private int loadMobsFromConfig(FileConfiguration config, String fileName) {
        ...
        for (String mobId : rootKeys) {
            ...
            if (!lootItems.isEmpty()) {
                ...
                mobCount++;
                plugin.getLogger().info("Loaded " + lootItems.size() + " loot items for mob '" + mobId + "' from " + fileName +
    ...
    private LootItem parseNewFormatLoot(String lootLine) {
        try {
            ...
            int minDrops = Integer.parseInt(params.getOrDefault("min-drops", "1"));
            int maxDrops = Integer.parseInt(params.getOrDefault("max-drops", String.valueOf(minDrops)));
