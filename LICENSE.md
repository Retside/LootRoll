...
- Redistribute **compiled** versions of LootRoll.  
- Redistribute **modified or unmodified** source code.  
- Sell, publish, or share this plugin in any form.  
...
- Running LootRoll on a **commercial** server.  
- Using LootRoll as part of a paid product or service.  
- Receiving official support or updates.
